...
async function writeExifImg(media, metadata) {
  ...
  if (metadata.packname || metadata.author) {
    ...
    const json = {
      "sticker-pack-id": "SC Bot By @VannessWangsaff",
...
module.exports.imageToWebp = imageToWebp;
module.exports.videoToWebp = videoToWebp;
module.exports.writeExifImg = writeExifImg;
module.exports.writeExifVid = writeExifVid;
module.exports.writeExif = writeExif;
module.exports.exifAvatar = exifAvatar;
